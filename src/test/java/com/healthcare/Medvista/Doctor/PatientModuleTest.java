...
public class PatientModuleTest {
	...
	public void registerPatient() throws IOException, InterruptedException {
		...
		{
		try {
			driver.findElement(By.xpath("//span[text()='Mar']/ancestor::div[@class='datepicker-months']/preceding-sibling::div[@class='datepicker-days']//td[text()='14']")).click();
